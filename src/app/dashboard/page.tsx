        ...
        <div className="flex-1 overflow-y-auto p-4 lg:p-8">
          <div className="mx-auto flex h-full max-w-5xl flex-col gap-8">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-6 border-b border-[#232f48]">
                ...
                <button className="border-b-2 border-transparent pb-3 text-sm font-medium text-[#92a4c9] transition-colors hover:border-[#334155] hover:text-white">
                  All Blogs
                </button>
                <button className="border-b-2 border-transparent pb-3 text-sm font-medium text-[#92a4c9] transition-colors hover:border-[#334155] hover:text-white">
                  Liked Blogs
