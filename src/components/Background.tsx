  ...
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none bg-[#020617]">
      ...
      */}
      ...
      {/* Base glow */}
      <div
        className="absolute top-[-50%] left-[-50%] w-[200%] h-[200%] animate-aurora-1 opacity-50"
        style={{
      ...
      <div
        className="absolute top-[-50%] right-[-50%] w-[200%] h-[200%] animate-aurora-2 opacity-40"
        style={{
      ...
      {/* Tertiary cyan glow */}
      <div
        className="absolute bottom-[-50%] left-0 w-[150%] h-[150%] animate-aurora-3 opacity-30"
        style={{
