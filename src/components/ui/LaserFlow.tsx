...
const LaserFlow: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    const renderer = new THREE.WebGLRenderer({
      antialias: false,
      alpha: true, // changed to true so background can be transparent
      depth: false,
      stencil: false,
    ...
    // renderer.setClearColor(0x000000, 1); // Removed clear color to allow transparency
    ...
    const material = new THREE.RawShaderMaterial({
      ...
      depthTest: false,
      depthWrite: false,
      blending: THREE.NormalBlending // Or THREE.AdditiveBlending depending on desired look
    });
